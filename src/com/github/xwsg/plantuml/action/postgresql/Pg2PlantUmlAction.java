...
/**
 * Generate PlantUML from PostgreSQL DDL Action.
 *
 * @author xwsg
 */
public class Pg2PlantUmlAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (project != null && ddlFile != null) {
            ...
            ProgressManager
                .getInstance().run(new Task.Backgroundable(project, "Pg2PlantUml generation", false) {
                @Override
                public void run(@NotNull ProgressIndicator indicator) {
                    // Generate DDLs
                    new Pg2PlantUmlGenerator().generate(ddlFile);
                    // refresh
